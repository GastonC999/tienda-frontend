...
const SLIDES = [
  {
    ...
    subtitle: 'Granos seleccionados, tostados con dedicación',
    cta: 'Ver cafés',
  ...
  },
  {
    ...
    subtitle: 'Productos de calidad para tu bienestar',
    cta: 'Ver productos',
  ...
  {
    title: 'Bienvenido a Moccana',
    subtitle: 'Donde el café y el cannabis se encuentran',
    cta: 'Explorar tienda',
    href: '/products',
    bg: 'from-[#1A0A0A] to-[#4A1010]',
    accent: '#C8902A',
    tag: '✦ Moccana Grow',
  },
]
